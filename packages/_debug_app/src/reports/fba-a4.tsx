...
export let fbaA4ReportHandler: Lambda = (event: FbaPrintJob, context, callback) => RedAgate.renderOnAwsLambda(
<Html5>
    <head>
        <title>FBA</title>
...
export let fbaBrDKReportHandler: Lambda = (event: FbaPrintJob, context, callback) => RedAgate.renderOnAwsLambda(
<Html5>
    <head>
        <title>FBA</title>
